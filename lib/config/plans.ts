...
export const PLANS: PlanDef[] = [
  ...
  //
  // `estudiantes` es el TECHO del tramo: 150, 300, 500, 800. Los avisos de
  // WhatsApp NO se calcularon sobre ese techo sino sobre el colegio típico
  // de cada banda —100, 225, 400 y 650—, a tres por estudiante al mes: la
  // factura, el recordatorio y el vencido. De ahí 300 = 3×100 y
  // 1,950 = 3×650.
  //
  // La consecuencia, que conviene tener presente y no descubrir por un
  // reclamo: el colegio que llena su tramo recibe ~2 avisos por estudiante,
  // no 3. Básico con 150 alumnos tiene 300 mensajes para unos 450 envíos de
  // un mes normal. Es una decisión de precio, no un descuido — subirlos a
