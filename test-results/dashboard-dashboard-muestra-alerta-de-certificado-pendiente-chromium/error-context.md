...
- Name: dashboard.test.ts >> dashboard muestra alerta de certificado pendiente
- Location: tests/dashboard.test.ts:36:5
...
Locator: getByText('Certificado digital no configurado')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Certificado digital no configurado')
