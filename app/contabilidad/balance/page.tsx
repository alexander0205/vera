  ...
  return (
    <Box component="section" sx={{ p: { xs: 2, sm: 3 }, maxWidth: 1400, mx: 'auto', display: 'flex', flexDirection: 'column', gap: 2.5 }}>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.75 }}>
        ...
        <Typography component="span" sx={{ fontSize: '0.875rem', color: '#3658e1', fontWeight: 500 }}>Balance de comprobación</Typography>
      </Box>
      ...
      <FiltrosPeriodo ruta="/contabilidad/balance" periodo={{ desde, hasta }} />
              ...
              {balance.filas.map((f) => (
                <TableRow key={f.cuentaId} hover>
                  <TableCell>
                    <Box
                      component="a"
                      href={`/contabilidad/mayor?cuentaId=${f.cuentaId}${
                  ...
                  <TableCell colSpan={5} sx={{ py: 6, textAlign: 'center', color: '#9ca3af' }}>
                    {desde || hasta ? (
                      ...
                      <>
                        ...
                        <Box component="a" href="/contabilidad/libro-diario" sx={{ fontWeight: 500, textDecoration: 'underline', color: 'inherit' }}>
