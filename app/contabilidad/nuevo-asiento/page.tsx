  ...
  return (
    <Box component="section" sx={{ p: { xs: 2, sm: 3 }, maxWidth: 1100, mx: 'auto', display: 'flex', flexDirection: 'column', gap: 2.5 }}>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.75 }}>
        ...
        <Typography component="span" sx={{ fontSize: '0.875rem', color: '#3658e1', fontWeight: 500 }}>Nuevo asiento manual</Typography>
      </Box>
      ...
      {cuentas.length === 0 ? (
        <Typography sx={{ bgcolor: '#fff', border: '1px solid #e5e7eb', borderRadius: '12px', px: 2, py: 5, textAlign: 'center', fontSize: '0.875rem', color: '#6b7280' }}>
          ...
          <Box component="a" href="/contabilidad/cuentas" sx={{ fontWeight: 500, textDecoration: 'underline', color: 'inherit' }}>
