      ...
      {empresa?.logo ? (
        ...
        <Box
          ...
          sx={{
            ...
            '&:hover': { borderColor: '#3658e1' }, transition: 'border-color 0.15s',
          }}
        >
      ...
      <Box sx={{ minWidth: 0 }}>
        ...
        {showCambiarEmpresa && (
          <Box
            component={Link}
            href="/dashboard/configuracion"
            sx={{ fontSize: '0.6875rem', color: '#2a45c4', lineHeight: 1.25, mt: '4px', display: 'inline-block', textDecoration: 'none', '&:hover': { textDecoration: 'underline' } }}
          >
            Cambiar empresa
          </Box>
        )}
