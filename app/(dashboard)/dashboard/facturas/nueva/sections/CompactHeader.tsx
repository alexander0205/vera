        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.75, fontSize: '0.75rem' }}>
          ...
          {puedeEditarFecha && sinNcfEfectivo ? (
            <Box
              ...
              sx={{
                fontSize: '0.75rem', fontWeight: 500, color: '#111827', fontFamily: 'inherit',
                border: '1px solid #e5e7eb', borderRadius: '4px', px: 0.75, py: '2px',
                '&:focus': { outline: 'none', borderColor: '#0f766e', boxShadow: '0 0 0 1px #0f766e' },
              }}
            />
          ) : (
