...
const CARDS = [
  { href: '/cuenta/empresa',  title: 'Mi empresa',         desc: 'Datos fiscales, logo, dirección y ajustes del negocio.',        icon: Building2, billing: false },
  { href: '/cuenta/usuarios', title: 'Usuarios',           desc: 'Invita a tu equipo y define a qué módulo entra cada quien.',    icon: Users,     billing: false },
  { href: '/cuenta/roles',    title: 'Roles y permisos',   desc: 'Crea roles a medida y controla qué puede hacer cada rol.',      icon: ShieldCheck, billing: false },
  { href: '/cuenta/plan',     title: 'Plan y facturación', desc: 'Tu plan, límites de uso y método de pago.',                     icon: CreditCard, billing: true },
  { href: '/cuenta/empresas', title: 'Mis empresas',       desc: 'Cambia de negocio o crea uno nuevo.',                           icon: Layers,    billing: false },
].filter(c => BILLING_ENABLED || !c.billing);
  ...
  return (
    <Box sx={{ p: { xs: 2, sm: 3 }, maxWidth: 1100 }}>
      ...
      <Typography variant="body2" sx={{ color: 'text.secondary', mt: 0.5, mb: 3 }}>
        Todo lo de {perfil?.razonSocial ?? 'tu negocio'}: datos de la empresa, tu equipo y tus permisos.
      </Typography>
